		...
		paragraphs: [
			{
				...
				content: [
					'He has previously interned as a research assistant in Ethiopia. During his time in Ethiopia, he participated in a high-level meeting on resource management and wrote a concept note on the 2016-17 Horn of Africa Drought. This experience gave him an understanding of the flow of high-level meetings, creating briefing notes, and drafting detailed minutes.',
					'Furthermore, Guilherme has previous experience in developing and maintaining newsletters, where he was responsible for writing articles, editing, and distributing the newsletter.',
					'During his studies, he undertook several academic projects, including a management consultancy project in association with the City Hall of Rotterdam and a sanctions project on Chinese media censorship in collaboration with the Dutch Ministry of Foreign Affairs.',
				],
			},
			{
				title: 'At Time&Place Group',
				content: [
					'Guilherme joined Time&Place Group in October 2023. His contributions so far have come through an active role in policy monitoring and analysis of EU regulations, conceptualizing position papers, drafting concise presentations for high-level meetings, and stakeholder mapping.',
					'These contributions have come mainly in the field of e-mobility, where Guilherme has been able to expand his involvement in several areas such as charging infrastructure, standardization, types of charging, and smart grids; particularly within the scope of CharIN e.V.',
		...
		paragraphs: [
			{
				title: 'Previous Experiences',
				content: [
					"Matheus' past roles include working in Danone's Global Public Affairs team in Paris, developing advocacy strategies and building public policy positions for the company. He also served as Head of Press and Political Affairs at the Consulate General of France for Northeast Brazil, where he represented French interests with the Brazilian government and in the media.",
					'He has worked with corporate events at the American Chamber of Commerce for Brazil (AmCham) and at the social enterprise TIE, developing partnerships and advocacy campaigns with international NGOs.',
					"Matheus holds a Bachelor's degree in Political Science from the Federal University of Pernambuco (Brazil) and a Master's degree in Public & Institutional Communications from Sciences Po Strasbourg (France).",
				],
			},
			{
				title: 'Role at Time&Place Consulting',
				content: [
					'In August 2024, Matheus joined Time&Place Consulting as Public Affairs Coordinator in Brazil, where he champions advocacy initiatives and strategic communications on behalf of our clients. He brings to the table his experiences working with public institutions, grassroots organisations, and multinationals to promote change and lasting impact in policy and regulatory affairs.',
					'In doing so, he leverages his knowledge in fields such as e-mobility, food, health, and renewable energies across different continents and cultures.',
				],
			},
			{
