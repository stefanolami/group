const team = {
	...
	corina: {
		...
		introduction:
			'With a career focused on creative industries, Corina Cătălina Gheorgheza started more than 16 years ago in the beauty industry, where she worked as a Brand Manager for Romania and the Balkans, spearheading an exclusive product line at Sephora Romania. She gained experience in market research, customer trends, business controlling, budget management and also in copywriting, content creation, and storytelling. Her portfolio includes collaborations with entities such as UNTOLD Group, a company that organizes the largest music festivals in Eastern Europe and Middle East, as well as Remember Enescu Foundation, Edurights4Girls – Equal Access to Education, and in the cinematic domain as event coordinator for the movie “Beside Me” - directed by Tedy Necula. ///Corina stands as a co-founder of a pioneering initiative in Behavioral Analysis and Criminal Profiling, in collaboration with the Romanian Behavioral Analysis Unit under the umbrella of the General Inspectorate of the Romanian Police. ///Certified as a trainer, project manager, behavioral analyst, forensic & psychological profiler and psychologist, she offers a blend of expertise to her clients. ///Currently serving as the Creative and Operations Manager for Time&Place Group, Corina activates as creative strategist, social media manager, project developer and business controller.',
		paragraphs: [
			{
				title: 'Financial Liaison & Business Controller',
				content:
					'As a Financial Liaison Officer and Business Controller, Corina is developing and maintaining legal and financial systems. Her approach involves planning, directing, and controlling legal and financial operations, establishing budgets, forecasting cash flows, and providing financial analysis. ',
				endorsement: {
					content:
						'“Mrs. Corina Gheorgheza stood out through her intelligence, sustained work capacity and strong motivation in settling rigorousness, methodical approach of Science applied in uncertain forensic situations, calm handling of anny issues and changes occuring in the legal cases. \nDuring the scientific activities in which she participated, i noticed that her professionalism and interest have contribuited to the fast settlement of forensic psychology.” ',
					name: 'Dr. Psih. Com. Șef Dorin Dumitran ',
			...
			},
			{
				...
				content:
					'Whether conceptualizing multimedia campaigns or crafting narratives that align with brand identities, Corina brings creativity and strategic thinking to her content creation endeavors. ',
				endorsement: {
					content:
						"“Corina brought a wealth of expertise to the table, demonstrating a deep understanding of effective communication strategies. She skillfully crafted messages that resonated with our target audience, ensuring our project's objectives were effectively conveyed and understood. ///Her proactive approach and attention to detail were invaluable assets to our team. Corina took the initiative to identify opportunities for improvement and implement innovative communication solutions, which significantly enhanced our project's visibility and impact. ///It was a pleasure having Corina in our team. She brings enthusiasm, creativity, and a collaborative spirit to every task, inspiring those around her to strive for excellence.” ",
					name: 'Alexandra Bălșeanu',
					title: 'President GO-AHEAD Association',
				},
			},
			{
				title: 'Forensic & Psychological Profiler and Behavioral Analyst',
				content:
					'As a forensic & psychological profiler and behavioral analyst, Corina has developed her skills in understanding human behavior, motivations, and thought processes. Her expertise spans across various sectors, including law enforcement, corporate environments, and clinical settings. ',
				endorsement: {
					content:
						'For the collaboration with me in the campaign for the release of my first feature film, Corina meant more than the extra mile, as both strategic and executive involvement. She worked very hard and the effect was seen, the film was searched by tens of thousands of people. She is creative and goes deep into projects that bear her stamp. ',
					name: 'Tedy Necula',
					title: 'Inspirational Film & Ads Director / Producer, Producer at Inspirational Filmmaking & Necula Agency',
				},
			},
			{
				title: 'Publications, Training & Languages',
				content:
					'Corina is writing monthly psychology-focused articles and has conducted training sessions for Sephora employees in Romania and Bulgaria. Additionally, she has facilitated workshops for Boots stores employees in London under the Boots Fashion Brands Workshops initiative. ///Corina speaks Romanian, English, Spanish whilst improving her French. ',
				endorsement: {
					content:
						'Mrs. Corina Cătălina Gheorgheza has been collaborating with the Remember Enescu Cultural Foundation for more than 5 years, dealing with the communication and promotion of our artistic events on our social media platforms. ///I had the pleasure of witnessing on the occasion of this collaboration, a high level of professionalism, promptness, seriousness, involvement and a lot of dedication. ///I warmly recommend Mrs. Corina Cătălina Gheorgheza for any collaboration or project. ',
	...
	cristina: {
		name: 'Cristina Maria Andriuc',
		path: 'cristina-andriuc',
		titles: ['Founder & CEO - Time&Place Group'],
		contact: {
			phone: '+32 (0) 485 382 221',
			email: 'cezanne@groupontap.com',
			address: 'Rue de la Loi 81 A, 1040 Brussels, Belgium',
		...
		paragraphs: [
			{
				...
				content:
					'Cristina specialized as well into product design in the lighting industry. For 5 years, she brought a fresh and innovative perspective, contributing to the development and launch of successful products on the market. Her experience in this field has allowed her to improve her technical skills and to understand aspects such as functionality, ergonomics, and aesthetics in a deeper way.',
				endorsement: {
					content:
		...
		paragraphs: [
			{
				...
				content:
					'Before diving into web development, Stefano spent 10 years working as a Cook and kitchen Chef. Following a cherished family tradition, he started honing his skills in the kitchen alongside his father in 2009. This passion led him to a prestigious cooking school in Florence, Italy, further solidifying his expertise. ///He worked for several years in renowned restaurants throughout Modena, Italy, where he broadened his culinary repertoire and thrived in demanding kitchen environments. In 2015, Stefano relocated to Berlin, Germany, and continued refining his craft at two acclaimed Italian restaurants until 2019.',
			},
			{
				title: 'Web Development',
				content:
					"Stefano's path to web development began with a keen interest in technology, complementing his successful career as a chef. This background instilled in him valuable skills like meticulous attention to detail, project management, and the ability to meet deadlines under pressure – all crucial assets in the web development world. ///In 2019, Stefano decided to pursue his passion for programming and embarked on a focused learning journey. He completed a web development program and honed his skills by building various websites and web applications as a freelancer.",
			},
			{
				title: 'Time&Place Group',
				content:
					'Since joining Time&Place Group in February 2023, Stefano has become an integral part of the team, contributing to the development and maintenance of our digital presence. He is a quick learner, always eager to expand his knowledge and tackle new challenges. ///Stefano speaks English, Italian, German and Romanian.',
			},
		],
	},
}
