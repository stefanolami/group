		...
		>
			...
			<div className="mx-auto lg:mx-0 w-[90%] lg:w-2/5">
				...
				<Link
					...
					href=""
					className="flex text-white items-center justify-center pt-[2px] mt-10 w-28 lg:w-48 h-6 lg:h-8 ml-auto text-xs lg:text-lg font-jose font-bold rounded-md shadow-md  hover:shadow-xl hover:brightness-90"
				>
					Read More
				</Link>
			</div>
